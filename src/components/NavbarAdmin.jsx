...
<ul className="hidden md:flex gap-6 items-center text-sm font-medium whitespace-nowrap">
          <li>
            <Link to="/adminpending" className="hover:text-white hover:bg-blue-600 px-3 py-1 rounded transition">
              الصفحة الرئيسية
            </Link>
          </li>
            <li>
                      <Link to="/adminfinancial" className="hover:text-white hover:bg-blue-600 px-3 py-1 rounded transition">
                        البيان المالي للتسديد
                      </Link>
                    </li>
          <li>
            <Link to="/adminPaymentStatement" className="hover:text-white hover:bg-blue-600 px-3 py-1 rounded transition">
